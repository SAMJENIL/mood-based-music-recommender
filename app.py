...
SPOTIPY_CLIENT_ID = os.environ.get("SPOTIPY_CLIENT_ID", "167e5c78dcaf42a5a8ef32bb0fe3047e")
SPOTIPY_CLIENT_SECRET = os.environ.get("SPOTIPY_CLIENT_SECRET", "860edfe1034a4bdfad9b57992d66882a")
